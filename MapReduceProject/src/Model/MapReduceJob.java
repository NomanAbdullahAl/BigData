...
public abstract class MapReduceJob<M extends Mapper, R extends Reducer, K, V> extends Configured implements Tool {
    ...
    public void setPartitioner(Class<? extends Partitioner> cls) throws IllegalStateException {
